package com.example.thedeveloper.gtsaw.Utils;
...
/*Usage
 @SuppressLint("ResourceType")
        View beneathView =findViewById(R.drawable.bg3) ;
        @SuppressLint("ResourceType") View blurView =findViewById(R.layout.activity_main) ;
        BlurDrawable blurDrawable = new BlurDrawable(beneathView, 10);
